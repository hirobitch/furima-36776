class PurchaseAddress
  ...
  def save
    purshase = Puchase.create(user: user, item: item)
    address = Address.create(postal_code :postal_code, ship_from_address :ship_from_address, municipality :municipality, address :address, building :building, tell :tell, purchase :purchase)
  end
end
